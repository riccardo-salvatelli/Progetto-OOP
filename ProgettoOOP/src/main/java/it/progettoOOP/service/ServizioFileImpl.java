...
public class ServizioFileImpl implements ServizioFile {
	...
	/**
	 * @param id indica l'id del file
	 * @return <code>boolean</code> <code>true</code> se il file viene cancellato
	 *         con successo
	 */
	public boolean cancellaFile(String id) {
		try {
			java.io.File file = new java.io.File(fileRepo.get(id).getPercorso() + '/' + fileRepo.get(id).getNome());
...
//          se lo ha trovato lo rimuove e ritorna true
	 ...
	 * @throws ChiaviErrateException viene lanciata nel momento in cui le chiavi
	 *                               sono sbagliate
	 * @throws ChiaviNullException   viene lanciata quando le chiavi sono
	 *                               <code>null</code>
	 ...
	 * file caricati
	 *
	 * @return <code>HashMap&lt;String,Double&gt;</code> contiene il nome
	 *         dell'autore con la relativa percentuale
	 ...
	 * @return <code> Vector&lt;File&gt; </code> che contiene i file che soddisfano
	 *         il fitro.
	 */
